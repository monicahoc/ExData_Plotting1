...
# Create a plot of time (day of the week) vs Global Active Power (second plot 
# requested) as a PNG file  with a width of 480 pixels and a height of 480 pixels
# The file is called "plot2"
...
plot(dayInCharacters, subsetEnergyData$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
